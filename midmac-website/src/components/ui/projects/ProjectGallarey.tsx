...
export const ProjectGallery = ({ media }: ProjectGalleryProps) => {
  ...
  return (
    <div className="flex flex-col md:grid md:grid-cols-[1fr,100px] lg:grid-cols-[1fr,120px] xl:grid-cols-[1fr,140px] gap-4 px-4 h-auto md:h-[calc(100vh-400px)] min-h-[400px]">
      {/* Main Preview Image */}
      <div className="relative w-full aspect-[4/3] md:h-full overflow-hidden bg-[#1A1A1A]">
            ...
            {mediaFetched.map((mediaItem: MediaItem, index: number) => {
              ...
              return (
                <button
                  ...
                  className="relative w-[80px] md:w-full aspect-square group overflow-hidden bg-[#1A1A1A]"
                >
                  <Image
                  ...
                  <div
                    className={`absolute inset-0 transition-opacity ${
                      selectedIndex === index
                        ...
                        : 'bg-transparent group-hover:bg-[rgba(26,26,26,0.7)]'
                    }`}
                  />
                </button>
              )
